...
const Testim: React.FC = () => {
  ...
  return (
    ...
    {/* Move the Slider component outside the row */}
    <Slider {...settings} className="mx-auto">
      {slidesContent.map((slide, index) => (
        <div
          key={index}
          className="slick-slide md:h-386 w-full md:w-[500px] h-[350px] md:w-320 rounded-2xl border-2 border-black py-4 px-4 md:mr-20"
        >
          <p
